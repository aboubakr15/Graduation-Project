...
[تعليمات اللغة — أولوية قصوى]:
يجب أن تُجيب باللغة العربية فقط. المصطلحات التقنية والعلمية (مثل: Linear Regression, Algorithm, Machine Learning) تبقى بالإنجليزية كما هي. ممنوع منعاً باتاً استخدام أي حروف أو كلمات من لغات أخرى كالصينية أو اليابانية أو الكورية أو أي لغة سوى العربية والإنجليزية للمصطلحات التقنية.
    ...
    def generate_enrolled_topic_answer(self, question: str, history: list = None) -> str:
        ...
        if has_arabic:
            sys_prompt = (
                ...
                "[تعليمات اللغة — إلزامية]: يجب أن تُجيب باللغة العربية فقط. "
                "المصطلحات التقنية (مثل Linear Regression, Algorithm) تبقى بالإنجليزية. "
                "ممنوع منعاً باتاً استخدام أي حروف صينية أو يابانية أو كورية أو أي لغة أخرى."
            )
        else:
            sys_prompt = (
...
[تعليمات اللغة — إلزامية]: يجب أن تُجيب باللغة العربية فقط. المصطلحات التقنية والعلمية (مثل Linear Regression, Algorithm, Machine Learning) تبقى بالإنجليزية كما هي. ممنوع منعاً باتاً استخدام أي حروف أو كلمات من لغات أخرى كالصينية أو اليابانية أو الكورية.
قواعد صارمة:
